...
//********************************************************
//********************************************************
#ifdef AeroQuad_Skyworks
  // LSM Sensor
  #include <Adafruit_LSM9DS0.h>
  #include <Adafruit_Sensor.h>
  // Init for I2C (SPI is not supported on Edison because it uses ATMega registers.)
  Adafruit_LSM9DS0 lsm = Adafruit_LSM9DS0();
  

  // Edison does not support these macros by default.
...
//********************************************************
  ...
  #error Bluetooth receiver hasn't been integrated yet. This new firmware build will not compile with edison receiver logic!
#endif
...
//********************************************************
  ...
  #include <Motors_STM32.h>    
#elif defined(MOTOR_EDISON)
  #include <motors_edison.h>
#endif
